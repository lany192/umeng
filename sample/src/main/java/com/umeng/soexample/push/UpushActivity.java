                    ...
                    public void run() {
                        if (isSuccess) {
                            ...
                            PushDialogFragment.newInstance(1, 1, getString(R.string.push_get_tags),
                                    builder.toString()).show(getSupportFragmentManager(), "deleshowWeightedTagteTag");
                        } else {
                            PushDialogFragment.newInstance(1, 0, getString(R.string.push_get_tags),
                                    "").show(getSupportFragmentManager(), "showWeightedTag");
                        }
                    }
                });
            }
                    ...
                    public void run() {
                        if (isSuccess) {
                            ...
                            PushDialogFragment.newInstance(0, 1, getString(R.string.push_delete_success),
                                    inputWeightedTag.getText().toString()).show(getSupportFragmentManager(), "deleteWeightedTag");
                        ...
                        if (isSuccess) {
                            ...
                            PushDialogFragment.newInstance(0, 1, getString(R.string.push_add_success),
                                    inputWeightedTag.getText().toString() + "\n" + getString(R.string.push_tag_value) +
                                            inputWeightedTagValue.getText().toString()).show(getSupportFragmentManager(),
                                    "addWeightedTag");
                            inputWeightedTag.setText("");
                            inputWeightedTagValue.setText("");
                        } else {
                            PushDialogFragment.newInstance(0, 0, getString(R.string.push_add_fail),
                                    inputWeightedTag.getText().toString() + "\n" + getString(R.string.push_tag_value) + inputWeightedTagValue.getText()
                                            .toString()).show(getSupportFragmentManager(), "addWeightedTag");
                        }
                    }
                });
            }
                ...
                handler.post(new Runnable() {
                    ...
                    public void run() {
                        if (isSuccess) {
                            ...
                            PushDialogFragment.newInstance(1, 1, getString(R.string.push_get_tags),
                                    info.toString()).show(getSupportFragmentManager(), "deleteTag");
                        } else {
                            PushDialogFragment.newInstance(1, 0, getString(R.string.push_get_tags),
                                    "").show(getSupportFragmentManager(), "deleteTag");
                        }
                    }
                });
            }
                    ...
                    public void run() {
                        ...
                        if (isSuccess) {
                            ...
                            PushDialogFragment.newInstance(0, 1,
                                    getString(R.string.push_delete_success), tag).show(getSupportFragmentManager(), "deleteTag");
                        } else {
                            PushDialogFragment.newInstance(0, 0,
                                    getString(R.string.push_delete_fail), tag).show(getSupportFragmentManager(), "deleteTag");
                        }
                    }
                });
            }
                    ...
                    public void run() {
                        ...
                        if (isSuccess) {
                            ...
                            PushDialogFragment.newInstance(0, 1, getString(R.string.push_add_success), tag).show(
                                    getSupportFragmentManager(), "addTag");
                        } else {
...
//    }
    ...
    private void deviceCheck() {
        ...
        PushDialogFragment.newInstance(1, 0, getString(
                R.string.push_device_check), info).show(getSupportFragmentManager(), "deviceCheck");
    }
}
